"""
Django settings for bulka_play_2 project.
...
INSTALLED_APPS = [
    ...
    # "debug_toolbar",  # Удалено для продакшена
...
MIDDLEWARE = [
    ...
    # "debug_toolbar.middleware.DebugToolbarMiddleware",  # Удалено для продакшена
]
...
WSGI_APPLICATION = "bulka_play_2.wsgi.application"
